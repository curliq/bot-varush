...
public class DbRequests {
    ...
    public static void saveTeam(String id, ArrayList<String> membersIds, String name, Integer league, Integer division,
            Integer points, String avatarId, Integer wins, Integer losses, Integer placementsLeft, Integer topLeague,
            ...
            public void run() {
                DbUtils.makeRequest(String.format(
                        "INSERT INTO %1$s (%2$s, %3$s, %4$s, %5$s, %6$s, %7$s, %8$s, %9$s, %10$s, %11$s, %12$s, "
                                + "%13$s, %14$s) VALUES ('%15$s', '%16$s', '%17$s', '%18$s', '%19$s', '%20$s', '%21$s', '%22$s', '%23$s', '%24$s', '%25$s', "
                                + "'%26$s', '%27$s') ON CONFLICT (%2$s) DO UPDATE SET %3$s = excluded.%3$s, %4$s = excluded.%4$s, "
